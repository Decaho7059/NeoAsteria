// NeoAsteria
//
// Copyright (c) 2025 Decaho Gbegbe
//
...
$(function () {
    ...
    if (!window.vector_battle) {
        console.warn("⚠️ vector_battle.js manquant : fallback en police normale");
        Text.renderText = function (text, size, x, y) {
            this.context.save();
